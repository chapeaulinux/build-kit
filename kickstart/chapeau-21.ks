...
#/usr/sbin/restorecon -R /etc/skel/* /etc/geoclue /etc/dconf/db/local.d /etc/dconf/profile/user /usr/share/icons/Fedora/48x48/apps/anaconda.png /usr/share/icons/Fedora/scalable/apps/anaconda.svg /usr/share/desktop-directories/*
/usr/sbin/restorecon -R /etc/* /usr/share/icons/Fedora/48x48/apps/anaconda.png /usr/share/icons/Fedora/scalable/apps/anaconda.svg /usr/share/desktop-directories/*
...
# the repo file but their Fedora 21 repo is not yet available
# (REMOVED)
