...
#repo --name="Chapeau" --baseurl=file:///chapeau/repo/23/x86_64/
#repo --name="Chapeau 32bit packages" --baseurl=file:///chapeau/repo/23/i386/
repo --name="Chapeau" --baseurl=file:///chapeau/repo/22/x86_64/
repo --name="Chapeau 32bit packages" --baseurl=file:///chapeau/repo/22/i386/
# Live repo
#repo --name="Chapeau" --baseurl=http://chapeaulinux.org/repo/23/x86_64/
#repo --name="Chapeau 32bit packages" --baseurl=http://chapeaulinux.org/repo/23/i386/
