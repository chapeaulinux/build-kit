...
#repo --name="RPMFusion Non-Free Updates" --baseurl=http://download1.rpmfusion.org/nonfree/fedora/updates/$releasever/Everything/x86_64/os/
...
## Steam - negativo17
#repo --name="Fedora Steam" --baseurl=http://negativo17.org/repos/steam/fedora-$releasever/$basearch/
...
repo --name=Korora --baseurl=http://mirror.linux.org.au/pub/korora/releases/22/x86_64/ --includepkgs=pharlap*,lens,*-lens,*-lens-*
